...
\noindent\textit{approximately ancillary:} %todo p. 132
also condition on approximate ancillaries (continuity principle) 
...
\paragraph{\large Influence Curve} \citep{van2011targeted}

influence curve IC(O): how robust is estimator toward extreme values

$mean IC(P_0) = 0$ and its finite variance is the asymptotic variance of the standard estimator  
