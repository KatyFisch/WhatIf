...
(5) \textit{\textbf{convergence in probability:}} sequence $(X_n)\to X$ if $\forall \epsilon{>}0$ $P(|X_n-X|>\epsilon)\overset{n\to\infty}{\to} 0$; (3)$\Rightarrow$(5), (4)$\Rightarrow$(5)
...
\textbf{Weak Law of Large Numbers} $X_i$ independent, $\mathbb{E}(X_i)=m$, $\mathrm{Var}(X_i)\leq K<\infty \Rightarrow \frac{S_n}{n} \to m$ (basis for Monte Carlo method)
...
(1) $\sum_{n=1}^\infty P(A_n)<\infty \Rightarrow P(\lim \sup_{n\to\infty} A_n)=0$

(2) $\sum_{n=1}^\infty P(A_n)=\infty \Rightarrow P(\lim \sup_{n\to\infty} A_n)=1$ (for $A_n$ indep.)
